  ...
  return (
    <section id="assortiment" className="bg-[#101211] text-white py-12 lg:py-20">
      <div className="main-container">
        ...
        <div className="assortiment-container grid grid-cols-12 gap-x-5 lg:gap-x-6 gap-y-10 lg:gap-y-12 mt-8 lg:mt-0">
          <div className="assortiment col-span-6 lg:col-span-3 flex items-center flex-col">
            ...
            <p className="text-[#838381] text-center font-josefin text-[10px] lg:text-[.9rem] leading-[15px] lg:leading-[20px] tracking-[.05px] lg:tracking-[.07px]">
