  ...
  return (
    <section id="waardaes" className="bg-[#e9e6d6] py-16 lg:py-20">
      <div className="main-container">
        ...
        <p className="text-center text-chocolate font-josefin text-[12px] lg:text-[1.1rem] font-light ledaing-[20px] lg leading-[15px]:lg:leading-[25px] mb-7 lg:mb-14 lg:px-16">
        ...
        <div className="waardaes-container grid grid-cols-12 gap-x-4 lg:gap-x-20 gap-y-10 lg:gap-y-16">
          <div className="waardae col-span-12 lg:col-span-4 flex items-center flex-col">
            ...
            <p className="text-center text-[#838381] font-josefin text-[.7rem] lg:text-[.9rem] font-normal leading-[15px] lg:leading-[25px] tracking-[.05px] lg:tracking-[.07px]">
